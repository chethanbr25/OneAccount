...
namespace One_Account
{
    public partial class ucQuickLaunch : UserControl
    {
        ...
        public void ReturnFromCustomization()
        {
            ...
            {
                MessageBox.Show("QL:1" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        /// <summary>
        ...
        public void AssignButtonText()
        {
            ...
            {
                MessageBox.Show("QL:2" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        #endregion
        #region Events
        ...
        private void ucQuickLaunch_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("QL:5" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        /// <summary>
        ...
        private void btn1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("QL:4" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        /// <summary>
        ...
        private void btnCustomizeMenu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("QL:3" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        /// <summary>
