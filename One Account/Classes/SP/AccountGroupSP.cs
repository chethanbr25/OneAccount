...
namespace One_Account
{
    class AccountGroupSP : DBConnection
    {
        ...
        public DataTable AccountGroupWiseReportForProfitAndLossLedger(decimal decAccountGroupId, DateTime dtmFromDate, DateTime dtmToDate)
        {
            ...
            {
                MessageBox.Show("AG:1" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public DataTable CheckWheatherLedgerUnderCash()
        {
            ...
            {
                MessageBox.Show("AGSP :1" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public bool AccountGroupwithLedgerId(decimal decLedgerId)
        {
            ...
            {
                MessageBox.Show("AGSP :2" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public DataTable AccountGroupReportFill(DateTime dtmFromDate, DateTime dtmToDate)
        {
            ...
            {
                MessageBox.Show("AGSP :3" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public DataTable AccountGroupWiseReportViewAll(decimal decAccountGroupId, DateTime dtmFromDate, DateTime dtmToDate)
        {
            ...
            {
                MessageBox.Show("AGSP :4" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public DataTable CashflowAccountGroupWiseReportViewAll(decimal decAccountGroupId, DateTime dtmFromDate, DateTime dtmToDate)
        {
            ...
            {
                MessageBox.Show("AGSP :5" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public DataTable CashInflowLoansAccountGroupWiseReportViewAll(decimal decAccountGroupId, DateTime dtmFromDate, DateTime dtmToDate)
        {
            ...
            {
                MessageBox.Show("AGSP :6" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public DataTable CashOutflowCurrentAssetAccountGroupWiseReportViewAll(decimal decAccountGroupId, DateTime dtmFromDate, DateTime dtmToDate)
        {
            ...
            {
                MessageBox.Show("AGSP :7" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
