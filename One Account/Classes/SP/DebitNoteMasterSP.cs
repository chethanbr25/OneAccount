...
namespace One_Account
{
    class DebitNoteMasterSP : DBConnection
    {
        ...
        public DataSet DebitNoteReportPrinting(string strFromDate, string strToDate, decimal decVoucherTypeId, decimal decLedgerId, decimal decCompanyId)
        {
            ...
            {
                MessageBox.Show("DNM:1" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public void DebitNoteVoucherDelete(decimal decDebitNoteMasterId, decimal decVoucherTypeId, string strVoucherNo)
        {
            ...
            {
                MessageBox.Show("DNM:2" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
