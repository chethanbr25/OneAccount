...
namespace One_Account
{
    class UserSP : DBConnection
    {
        ...
        public string LoginCheck(string strUserName)
        {
            ...
            {
                MessageBox.Show("USP:1" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
        ...
        public int GetUserIdAfterLogin(string strUserName, string strPassword)
        {
            ...
            {
                MessageBox.Show("USP:2" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
