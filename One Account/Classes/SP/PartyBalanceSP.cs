...
namespace One_Account
{
    class PartyBalanceSP : DBConnection
    {
        ...
        public bool PartyBalanceCheckReference(decimal decVoucherTypeId, string strVoucherNo)
        {
            ...
            {
                MessageBox.Show("PBSP:2" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
       ...
       /// <returns></returns>
        ...
        public DataTable AgeingReportVoucherPayable(DateTime ageingDate, decimal decledgerId)
        {
            ...
            {
                MessageBox.Show("MRSP1:" + ex.Message, "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            finally
            {
                sqlcon.Close();
