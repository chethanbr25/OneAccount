    ...
    public partial class frmSalesReturn : Form
    {
        ...
        public bool RemoveIncompleteRowsFromGrid()
        {
            ...
            try
            {
                ...
                if (inRowcount <= 2)
                {
                    ...
                    {
                        MessageBox.Show("Can't save purchase return without atleast one product with complete details", "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void FillRegisterOrReport()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("No record exists", "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Enter return no", "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtReturnNo.Focus();
                }
                ...
                {
                    MessageBox.Show("Select sales account", "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cmbSalesAccount.Focus();
                }
                else if (cmbCurrency.SelectedValue == null)
                {
                    MessageBox.Show("Select currency", "Oneaccount", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cmbCurrency.Focus();
                }
                else
                {
